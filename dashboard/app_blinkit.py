...
# Force Filter for Blinkit
filtered_df = df[df['platform'] == 'blinkit']

if filtered_df.empty:
    st.warning("No Blinkit data found.")
    st.stop()
...
with tab1:
    ...
    with col_chart1:
        ...
        fig_price = px.histogram(filtered_df, x="price", nbins=20, title="Price Distribution", color_discrete_sequence=['#F4D03F']) # Yellowish for Blinkit
