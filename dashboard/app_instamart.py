...
# Page Config
st.set_page_config(
    page_title="Instamart Analytics",
    page_icon="🛒",
    layout="wide"
)
...
# Force Filter for Instamart
filtered_df = df[df['platform'] == 'instamart']

if filtered_df.empty:
    st.warning("No Instamart data found.")
    st.stop()
...
with tab1:
    ...
    with col_chart1:
        ...
        fig_price = px.histogram(filtered_df, x="price", nbins=20, title="Price Distribution", color_discrete_sequence=['#E67E22']) # Orange for Instamart
